...
# 10. create a VCF file
	...
	commands = """
	cp /pylon2/bi4s86p/phuong/evolvability/2trim/{read1} ./
	cp /pylon2/bi4s86p/phuong/evolvability/2trim/{read2} ./
	cp /pylon2/bi4s86p/phuong/evolvability/2trim/{unpaired} ./
	cp /pylon2/bi4s86p/phuong/evolvability/9blastagain/{ref} ./
	...
	rm {out_paired}.sam {out_paired}.bam {out_unpaired}.sam {out_unpaired}.bam {sample}.raw.bam {read1} {read2} {unpaired}
	cp {sample}.* /pylon2/bi4s86p/phuong/evolvability/10mapagain
	cp {sample}_* /pylon2/bi4s86p/phuong/evolvability/10mapagain
	""".format(**variables)
