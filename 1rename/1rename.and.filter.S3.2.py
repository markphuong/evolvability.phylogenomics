...
directory = '/pylon2/bi4s86p/phuong/evolvability/0data/gslserver.qb3.berkeley.edu/170714_100PE_HS4K_UCSF/Alfaro'
...
def concat(element):
	...
	myfilename = newname[0] +'.' + newname[1] + '.' + newname[-2] + '.lane2.fq.gz'
