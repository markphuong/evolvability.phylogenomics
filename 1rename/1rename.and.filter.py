...
directory = '/pylon5/bi4s86p/phuong/evolvability/0data/gslserver.qb3.berkeley.edu/170830_100PE_HS4KA/Lane123567/Alfaro'
...
def concat(element):
	...
	myfilename = newname[0] +'.' + newname[1] + '.' + newname[-2] + '.fq.gz'
