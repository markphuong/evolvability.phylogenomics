...
# some names for input output files
	...
	sample = ID,
	myseq = ID.split('.')[0],
	mypath = '/pylon2/bi4s86p/phuong/evolvability/14treebuilding/20nexus'
	) #name your output
	...
	cp {myseq}.phylip /pylon2/bi4s86p/phuong/evolvability/16astral/20phylip
	cp RAxML*{myseq}* /pylon2/bi4s86p/phuong/evolvability/16astral/20raxml
	""".format(**variables)
