...
def concat(element):
	...
	commands = """
	cp /pylon5/bi4s86p/phuong/evolvability/3assembly/{index}_contigs.fasta ./
	...
	cp {index}.* /pylon5/bi4s86p/phuong/evolvability/4clustering
	cp {index}_* /pylon5/bi4s86p/phuong/evolvability/4clustering
	""".format(**variables)
