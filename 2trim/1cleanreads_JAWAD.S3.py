...
def align(element):
	...
	commands = """
	cp /pylon5/bi4s86p/phuong/evolvability/1rename/{sampleID}.*.gz ./
	zcat {sampleID}.R1.lane1.fq.gz {sampleID}.R1.lane2.fq.gz | gzip > {sampleID}.R1.fq.gz
	zcat {sampleID}.R2.lane1.fq.gz {sampleID}.R2.lane2.fq.gz | gzip > {sampleID}.R2.fq.gz
